...
const walletReportSchema = new mongoose.Schema({
  ...
  // addressAverage: { type: Number, required: true },
  ...
  // walletStartBalance: { type: Number, required: true },
      // 📉 Wallet balances
    walletStartBalance: { type: Number },
    walletStartBalanceInUSDT: { type: Number },
   addedAmount: { type: Number },
    addedAmountInUSDT: { type: Number },
    walletEndBalance: { type: Number },
    walletEndBalanceInUSDT: { type: Number },
